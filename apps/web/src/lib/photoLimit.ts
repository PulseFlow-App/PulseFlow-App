...
/** Max decoded image size: 2 MB. Reasonable for phone screenshots and photos. */
export const MAX_PHOTO_BYTES = 2 * 1024 * 1024;

/** Approx base64 length for 2 MB raw (4/3 * size). Client checks decoded size. */
export const MAX_PHOTO_BASE64_BYTES = Math.ceil((MAX_PHOTO_BYTES * 4) / 3);

/** Human-readable limit for UI messages. */
export const MAX_PHOTO_LABEL = '2 MB';
