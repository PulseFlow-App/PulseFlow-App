...
**Premium:** Subscribe via in-app purchase (IAP) in Profile. Policy-safe: no token gating in the app. $PULSE utility (governance, protocol credits, Lab access) lives off-app; see `docs/token-utility.md`.
