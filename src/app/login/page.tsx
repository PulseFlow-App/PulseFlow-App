...
const DEMO_ACCOUNTS: {
  ...
  { email: "owner@pulseflow.site", labelKey: "auth.demoOwner" },
  { email: "manager@pulseflow.site", labelKey: "auth.demoManager" },
  { email: "employee@pulseflow.site", labelKey: "auth.demoEmployee" },
];
              ...
              <div className="grid gap-2">
                {DEMO_ACCOUNTS.map((account) => (
                  <button
                    ...
                    className="rounded-2xl bg-[#F7F5F1] px-3 py-3 text-left transition hover:bg-primary-soft"
                  >
