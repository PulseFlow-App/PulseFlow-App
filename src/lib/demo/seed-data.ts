...
import { EMPTY_VILLA_DETAILS } from "@/lib/villas/property-details";

function facts(partial: Partial<VillaDetails>): VillaDetails {
  return { ...EMPTY_VILLA_DETAILS, ...partial };
}
...
export const demoContacts: Contact[] = [
  {
    ...
    messengers: [{ kind: "whatsapp", handle: null }],
  ...
  },
  {
    ...
    messengers: [{ kind: "line", handle: "mai.clean" }],
    notes: null,
  ...
  },
  {
    ...
    messengers: [{ kind: "line", handle: "beeelectric" }],
    notes: null,
    linked_profile_id: null,
  },
  {
