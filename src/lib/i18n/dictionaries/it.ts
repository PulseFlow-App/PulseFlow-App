...
const it: Dictionary = {
  ...
  "auth.demoEmployee": "Staff (pulizie)",
  ...
  "home.focusToday": "Focus di oggi",
  "home.focusTodayClear": "Niente di urgente al momento.",
  "home.focusTodayMore": "+{count} altri",
  ...
  "villas.details": "Dettagli della proprietà",
  "villas.detailsHint": "Tutto opzionale. Sulla scheda compaiono solo i campi compilati.",
  "villas.propertyType": "Tipo di proprietà",
  "villas.propertyType.villa": "Villa",
  "villas.propertyType.bungalow": "Bungalow",
  "villas.propertyType.house": "Casa",
  "villas.propertyType.apartment": "Appartamento",
  "villas.propertyType.studio": "Monolocale",
  "villas.propertyType.office": "Ufficio",
  "villas.propertyType.other": "Altro",
  "villas.sqm": "Superficie (m²)",
  "villas.sqmShort": "{n} m²",
  "villas.bedrooms": "Camere",
  "villas.bedroomsShort": "{n} cam.|{n} cam.",
  "villas.bathrooms": "Bagni",
  "villas.bathroomsShort": "{n} bagno|{n} bagni",
  "villas.maxGuests": "Ospiti max",
  "villas.maxGuestsShort": "{n} ospite|{n} ospiti",
  "villas.floors": "Piani",
  "villas.floorsShort": "{n} piano|{n} piani",
  "villas.pool": "Piscina",
  "villas.poolYes": "Piscina",
  "villas.poolNo": "Niente piscina",
  "villas.garden": "Giardino",
  "villas.gardenYes": "Giardino",
  "villas.gardenNo": "Niente giardino",
  "villas.wifi": "Wi-Fi",
  "villas.wifiYes": "Wi-Fi",
  "villas.wifiNo": "Niente Wi-Fi",
  "villas.pets": "Animali",
  "villas.petsYes": "Animali ok",
  "villas.petsNo": "Niente animali",
  "villas.yes": "Sì",
  "villas.no": "No",
  "villas.unset": "Non impostato",
  "villas.setting": "Tipo",
  "villas.setting.community": "In residence",
  "villas.setting.standalone": "Indipendente",
  "villas.parking": "Parcheggio",
  "villas.parking.none": "Niente parcheggio",
  "villas.parking.street": "In strada",
  "villas.parking.private": "Privato",
  "villas.kitchen": "Cucina",
  "villas.kitchen.none": "Niente cucina",
  "villas.kitchen.basic": "Cucina base",
  "villas.kitchen.full": "Cucina completa",
  "villas.aircon": "Aria condizionata",
  "villas.aircon.none": "Niente A/C",
  "villas.aircon.partial": "A/C parziale",
  "villas.aircon.full": "A/C completa",
  "villas.view": "Vista",
  "villas.view.sea": "Vista mare",
  "villas.view.jungle": "Vista giungla",
  "villas.view.pool": "Vista piscina",
  "villas.view.garden": "Vista giardino",
  "villas.view.mountain": "Vista montagna",
  "villas.delete": "Elimina proprietà",
  "villas.deleteConfirm":
    "Rimuovere {name} dall’azienda? L’azione è irreversibile.",
  "villas.deleteConfirmPersonal":
    "Rimuovere {name} dalla tua lista? L’azione è irreversibile.",
  "villas.photoUploading": "Caricamento foto…",
  "villas.notFound": "Proprietà non trovata.",
  ...
  "jobs.agreedBy": "Accettato da {name}",
  "jobs.readAgreed": "Letto e accettato",
  "jobs.readAgreedAsk": "Letto e accettato?",
  "jobs.awaitingAgreement": "In attesa del loro accordo",
  ...
  "contacts.linkUser": "Utente Pulse Flow (prenotazione in-app)",
  ...
  "settings.languageHint": "Scegli la lingua delle tue app Pulse Flow.",
  ...
  "settings.deleteInvite": "Elimina invito",
  "settings.inviteDeleteError": "Impossibile eliminare questo invito.",
  ...
  "billing.demoHint": "Modalità demo: pagamenti disattivati. L’azienda risulta Full così puoi esplorare gli strumenti owner.",
  ...
  "leaderboard.overall": "Il tuo rating Pulse Flow complessivo",
  ...
  "settings.translateContent": "Traduci i contenuti del team",
  "settings.translateContentHint.guest": "Briefing dell’host, messaggi di supporto e note sul soggiorno compaiono nella lingua della tua app.",
  "settings.translateContentHint.host": "Attività, chat, aggiornamenti degli ospiti e messaggi del team compaiono nella lingua della tua app.",
  "settings.translateContentHint.staff": "Attività, chat e messaggi del team compaiono nella lingua della tua app.",
  "settings.translateContentHint": "Attività, chat, briefing e messaggi dei colleghi compaiono nella lingua della tua app.",
