...
const es: Dictionary = {
  ...
  "nav.menuManage": "Gestionar",
  "nav.menuAccount": "Cuenta",
  ...
  "auth.demoEmployee": "Personal (limpieza)",
  ...
  "home.focusToday": "Foco de hoy",
  "home.focusTodayClear": "Nada urgente ahora.",
  "home.focusTodayMore": "+{count} más",
  ...
  "villas.details": "Detalles de la propiedad",
  "villas.detailsHint": "Todo opcional. En la tarjeta solo aparecen los campos rellenados.",
  "villas.propertyType": "Tipo de propiedad",
  "villas.propertyType.villa": "Villa",
  "villas.propertyType.bungalow": "Bungalow",
  "villas.propertyType.house": "Casa",
  "villas.propertyType.apartment": "Apartamento",
  "villas.propertyType.studio": "Estudio",
  "villas.propertyType.office": "Oficina",
  "villas.propertyType.other": "Otro",
  "villas.sqm": "Superficie (m²)",
  "villas.sqmShort": "{n} m²",
  "villas.bedrooms": "Dormitorios",
  "villas.bedroomsShort": "{n} hab.|{n} hab.",
  "villas.bathrooms": "Baños",
  "villas.bathroomsShort": "{n} baño|{n} baños",
  "villas.maxGuests": "Huéspedes máx.",
  "villas.maxGuestsShort": "{n} huésped|{n} huéspedes",
  "villas.floors": "Plantas",
  "villas.floorsShort": "{n} planta|{n} plantas",
  "villas.pool": "Piscina",
  "villas.poolYes": "Piscina",
  "villas.poolNo": "Sin piscina",
  "villas.garden": "Jardín",
  "villas.gardenYes": "Jardín",
  "villas.gardenNo": "Sin jardín",
  "villas.wifi": "Wi-Fi",
  "villas.wifiYes": "Wi-Fi",
  "villas.wifiNo": "Sin Wi-Fi",
  "villas.pets": "Mascotas",
  "villas.petsYes": "Se admiten mascotas",
  "villas.petsNo": "No mascotas",
  "villas.yes": "Sí",
  "villas.no": "No",
  "villas.unset": "Sin definir",
  "villas.setting": "Tipo",
  "villas.setting.community": "En comunidad",
  "villas.setting.standalone": "Independiente",
  "villas.parking": "Aparcamiento",
  "villas.parking.none": "Sin aparcamiento",
  "villas.parking.street": "En la calle",
  "villas.parking.private": "Privado",
  "villas.kitchen": "Cocina",
  "villas.kitchen.none": "Sin cocina",
  "villas.kitchen.basic": "Cocina básica",
  "villas.kitchen.full": "Cocina completa",
  "villas.aircon": "Aire acondicionado",
  "villas.aircon.none": "Sin A/A",
  "villas.aircon.partial": "A/A parcial",
  "villas.aircon.full": "A/A completo",
  "villas.view": "Vistas",
  "villas.view.sea": "Vistas al mar",
  "villas.view.jungle": "Vistas a la selva",
  "villas.view.pool": "Vistas a la piscina",
  "villas.view.garden": "Vistas al jardín",
  "villas.view.mountain": "Vistas a la montaña",
  "villas.delete": "Eliminar propiedad",
  "villas.deleteConfirm":
    "¿Quitar {name} de la empresa? Esto no se puede deshacer.",
  "villas.deleteConfirmPersonal":
    "¿Quitar {name} de tu lista? Esto no se puede deshacer.",
  "villas.photoUploading": "Subiendo foto…",
  "villas.notFound": "Propiedad no encontrada.",
  ...
  "jobs.agreedBy": "Aceptado por {name}",
  "jobs.readAgreed": "Leído y aceptado",
  "jobs.readAgreedAsk": "Leído y aceptado?",
  "jobs.awaitingAgreement": "Esperando que acepten",
  ...
  "contacts.linkUser": "Usuario Pulse Flow (reserva in-app)",
  ...
  "settings.languageHint": "Elige el idioma de tus apps Pulse Flow.",
  ...
  "settings.deleteInvite": "Eliminar invitación",
  "settings.inviteDeleteError": "No se pudo eliminar esta invitación.",
  ...
  "billing.demoHint": "Modo demo: el cobro está desactivado. Tu empresa se muestra como Full para explorar las herramientas de propietario.",
  ...
  "demo.contact.coolairNotes": "Spare parts in Thong Sala · not on Pulse Flow yet",
  ...
  "leaderboard.overall": "Tu valoración Pulse Flow global",
  ...
  "settings.translateContent": "Traducir el contenido del equipo",
  "settings.translateContentHint.guest": "Los briefings del anfitrión, los mensajes de soporte y las notas de la estancia aparecen en el idioma de tu app.",
  "settings.translateContentHint.host": "Las tareas, el chat, las actualizaciones de huéspedes y los mensajes del equipo aparecen en el idioma de tu app.",
  "settings.translateContentHint.staff": "Las tareas, el chat y los mensajes de tu equipo aparecen en el idioma de tu app.",
  "settings.translateContentHint": "Las tareas, el chat, los briefings y los mensajes del equipo aparecen en el idioma de tu app.",
