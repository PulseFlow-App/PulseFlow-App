...
const ar: Dictionary = {
  ...
  "nav.menuManage": "إدارة",
  "nav.menuAccount": "الحساب",
  ...
  "home.focusToday": "تركيز اليوم",
  "home.focusTodayClear": "لا يوجد شيء عاجل الآن.",
  "home.focusTodayMore": "+{count} أخرى",
  ...
  "villas.details": "تفاصيل العقار",
  "villas.detailsHint": "كلها اختيارية. تظهر على البطاقة الحقول المعبأة فقط.",
  "villas.propertyType": "نوع العقار",
  "villas.propertyType.villa": "فيلا",
  "villas.propertyType.bungalow": "بنغل",
  "villas.propertyType.house": "منزل",
  "villas.propertyType.apartment": "شقة",
  "villas.propertyType.studio": "استوديو",
  "villas.propertyType.office": "مكتب",
  "villas.propertyType.other": "أخرى",
  "villas.sqm": "المساحة (م²)",
  "villas.sqmShort": "{n} م²",
  "villas.bedrooms": "غرف النوم",
  "villas.bedroomsShort": "{n} غرفة|{n} غرف",
  "villas.bathrooms": "الحمامات",
  "villas.bathroomsShort": "{n} حمّام|{n} حمّامات",
  "villas.maxGuests": "الضيوف كحد أقصى",
  "villas.maxGuestsShort": "{n} ضيف|{n} ضيوف",
  "villas.floors": "الطوابق",
  "villas.floorsShort": "{n} طابق|{n} طوابق",
  "villas.pool": "مسبح",
  "villas.poolYes": "مسبح",
  "villas.poolNo": "بدون مسبح",
  "villas.garden": "حديقة",
  "villas.gardenYes": "حديقة",
  "villas.gardenNo": "بدون حديقة",
  "villas.wifi": "Wi-Fi",
  "villas.wifiYes": "Wi-Fi",
  "villas.wifiNo": "بدون Wi-Fi",
  "villas.pets": "حيوانات",
  "villas.petsYes": "مسموح بالحيوانات",
  "villas.petsNo": "بدون حيوانات",
  "villas.yes": "نعم",
  "villas.no": "لا",
  "villas.unset": "غير محدد",
  "villas.setting": "النوع",
  "villas.setting.community": "داخل مجمع",
  "villas.setting.standalone": "منزل مستقل",
  "villas.parking": "موقف",
  "villas.parking.none": "بدون موقف",
  "villas.parking.street": "في الشارع",
  "villas.parking.private": "موقف خاص",
  "villas.kitchen": "مطبخ",
  "villas.kitchen.none": "بدون مطبخ",
  "villas.kitchen.basic": "مطبخ بسيط",
  "villas.kitchen.full": "مطبخ كامل",
  "villas.aircon": "تكييف",
  "villas.aircon.none": "بدون تكييف",
  "villas.aircon.partial": "تكييف جزئي",
  "villas.aircon.full": "تكييف كامل",
  "villas.view": "الإطلالة",
  "villas.view.sea": "إطلالة بحر",
  "villas.view.jungle": "إطلالة غابة",
  "villas.view.pool": "إطلالة مسبح",
  "villas.view.garden": "إطلالة حديقة",
  "villas.view.mountain": "إطلالة جبال",
  "villas.delete": "حذف العقار",
  "villas.deleteConfirm": "إزالة {name} من الشركة؟ لا يمكن التراجع عن ذلك.",
  "villas.deleteConfirmPersonal":
    "إزالة {name} من قائمتك؟ لا يمكن التراجع عن ذلك.",
  "villas.photoUploading": "جارٍ رفع الصورة…",
  "villas.notFound": "العقار غير موجود.",
  ...
  "jobs.agreedBy": "وافق عليه {name}",
  "jobs.readAgreed": "قرأه ووافق عليه:",
  "jobs.readAgreedAsk": "قرأت ووافقت؟",
  "jobs.awaitingAgreement": "بانتظار موافقتهم",
  ...
  "settings.deleteInvite": "حذف الدعوة",
  "settings.inviteDeleteError": "تعذر حذف هذه الدعوة.",
  ...
  "billing.demoHint": "وضع تجريبي: الدفع متوقف. تظهر شركتك كـ Full حتى تستكشف أدوات المالك.",
  ...
  "guest.comingSoonHint": "House guide, support chat with owners/managers, deposit bills, and more properties from this company.",
  "guest.hi": "Hi {name}",
  ...
  "dateRequests.subtitle": "Accept to book the property dates on your calendar, or decline the request.",
  ...
  "dateRequests.depositHint": "When you add a deposit on a quote, choose in-advance or in-person. For in-advance, the guest pays via support chat and you confirm under Guests. For in-person, explain your rules in support chat.",
  ...
  "talent.settingsBioPlaceholder": "e.g. 5 years property cleaning in Phuket, own transport, English & Thai.",
