...
const he: Dictionary = {
  ...
  "nav.menuManage": "ניהול",
  "nav.menuAccount": "חשבון",
  ...
  "home.focusToday": "המיקוד להיום",
  "home.focusTodayClear": "אין דחוף כרגע.",
  "home.focusTodayMore": "+ עוד {count}",
  ...
  "villas.details": "פרטי הנכס",
  "villas.detailsHint": "הכול אופציונלי. בכרטיס מופיעים רק שדות שמולאו.",
  "villas.propertyType": "סוג נכס",
  "villas.propertyType.villa": "וילה",
  "villas.propertyType.bungalow": "בונגלו",
  "villas.propertyType.house": "בית",
  "villas.propertyType.apartment": "דירה",
  "villas.propertyType.studio": "סטודיו",
  "villas.propertyType.office": "משרד",
  "villas.propertyType.other": "אחר",
  "villas.sqm": "שטח (מ״ר)",
  "villas.sqmShort": "{n} מ״ר",
  "villas.bedrooms": "חדרי שינה",
  "villas.bedroomsShort": "{n} חד׳|{n} חד׳",
  "villas.bathrooms": "חדרי רחצה",
  "villas.bathroomsShort": "{n} מקל׳|{n} מקל׳",
  "villas.maxGuests": "אורחים מקס׳",
  "villas.maxGuestsShort": "{n} אורח|{n} אורחים",
  "villas.floors": "קומות",
  "villas.floorsShort": "{n} קומה|{n} קומות",
  "villas.pool": "בריכה",
  "villas.poolYes": "בריכה",
  "villas.poolNo": "בלי בריכה",
  "villas.garden": "גינה",
  "villas.gardenYes": "גינה",
  "villas.gardenNo": "בלי גינה",
  "villas.wifi": "Wi-Fi",
  "villas.wifiYes": "Wi-Fi",
  "villas.wifiNo": "בלי Wi-Fi",
  "villas.pets": "חיות",
  "villas.petsYes": "מותר חיות",
  "villas.petsNo": "אסור חיות",
  "villas.yes": "כן",
  "villas.no": "לא",
  "villas.unset": "לא הוגדר",
  "villas.setting": "סוג",
  "villas.setting.community": "בקהילה",
  "villas.setting.standalone": "בית עצמאי",
  "villas.parking": "חניה",
  "villas.parking.none": "בלי חניה",
  "villas.parking.street": "חניה ברחוב",
  "villas.parking.private": "חניה פרטית",
  "villas.kitchen": "מטבח",
  "villas.kitchen.none": "בלי מטבח",
  "villas.kitchen.basic": "מטבח בסיסי",
  "villas.kitchen.full": "מטבח מלא",
  "villas.aircon": "מזגן",
  "villas.aircon.none": "בלי מזגן",
  "villas.aircon.partial": "מזגן חלקי",
  "villas.aircon.full": "מזגן מלא",
  "villas.view": "נוף",
  "villas.view.sea": "נוף לים",
  "villas.view.jungle": "נוף לג׳ונגל",
  "villas.view.pool": "נוף לבריכה",
  "villas.view.garden": "נוף לגינה",
  "villas.view.mountain": "נוף להרים",
  "villas.delete": "מחיקת נכס",
  "villas.deleteConfirm": "להסיר את {name} מהחברה? לא ניתן לבטל.",
  "villas.deleteConfirmPersonal": "להסיר את {name} מהרשימה? לא ניתן לבטל.",
  "villas.photoUploading": "מעלה תמונה…",
  "villas.notFound": "הנכס לא נמצא.",
  ...
  "jobs.agreedBy": "אושר על ידי {name}",
  "jobs.readAgreed": "קראתי והסכמתי",
  "jobs.readAgreedAsk": "קראתי והסכמתי?",
  "jobs.awaitingAgreement": "ממתין להסכמתם",
  ...
  "contacts.linkUser": "משתמש Pulse Flow (הזמנה באפליקציה)",
  ...
  "settings.languageHint": "בחר את שפת אפליקציות Pulse Flow שלך.",
  ...
  "settings.deleteInvite": "מחק הזמנה",
  "settings.inviteDeleteError": "לא ניתן למחוק את ההזמנה.",
  ...
  "billing.demoHint": "מצב דמו: אין תשלום. החברה מוצגת כ‑Full כדי שתוכל לנסות את כלי הבעלים.",
  ...
  "contacts.subtitleCompany": "חברו משתמש Pulse Flow כדי להזמין באפליקציה; לאחרים התקשרו",
  ...
  "leaderboard.overall": "הדירוג הכולל שלך ב‑Pulse Flow",
